...
class ProductController {
    ...
    public function createProduct($name, $description, $price, $stock, $category_id,
                                 $imagePath, $imagePath2, $imagePath3, $usuario_id) {
    ...
    // Actualizar
    public function updateProduct($producto_id, $usuario_id, $name, $description, $price, $stock, $category_id,
                                 $imagePath = null, $imagePath2 = null, $imagePath3 = null) {
