...
// Si no vienen datos de envío por POST, lo regresamos al paso anterior
...
<head>
    ...
    <style>
        ...
        .payment-form-col { flex: 1.5; }
        .payment-summary-col { flex: 1; }
        ...
        .payment-form-col select {
            ...
            border-radius: 8px; /* Bordes redondeados del Figma */
            margin-bottom: 16px;
            font-family: inherit;
        }
                ...
                <form action="app/controllers/cartController.php" method="POST" id="final-checkout-form">
                    ...
                    <div class="grid-3-cols">
                        <div>
                            ...
                            <input type="text" id="tarjeta" name="tarjeta" placeholder="1111 1111 1111 1111" required maxlength="19">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" id="expiracion" name="expiracion" placeholder="MM/AA" required maxlength="5">
                        </div>
                    </div>
                    ...
                    <div class="grid-2-cols">
                        ...
                        <div>
                            ...
                            <input type="text" id="cp_fact" name="cp_fact" placeholder="00000" required>
                        </div>
                    </div>
