...
$str_preparacion = date("d M H:i", strtotime("+2 hours", $fecha_compra));
$str_camino = date("d M H:i", strtotime("+1 day", $fecha_compra));
...
<head>
    ...
    <style>
        ...
        .tracking-card {
            background-color: #f5efe6; /* Color crema del Figma */
            border-radius: 12px;
            padding: 2rem;
        ...
        /* CORRECCIÓN: Quitamos el padding:0 para que respete los márgenes internos */
        .col-right { flex: 1.2; } 
        ...
        .horizontal-progress {
            ...
            border-top: none;
            border-radius: 0 0 12px 12px; /* Redondeamos las esquinas de abajo */
        }
        ...
        .progress-line-active {
            ...
            top: 50%;
            left: 0;
            width: 50%; /* Controla el progreso visual */
            height: 4px;
            background-color: #586a58;
            z-index: 2;
            transform: translateY(-50%);
        ...
        .progress-icon {
            width: 45px;
            height: 45px;
            background-color: #e0e0e0; /* Gris claro inactivo */
            border-radius: 50%;
            display: flex;
            align-items: center;
            ...
            z-index: 3;
            position: relative;
            border: 3px solid white; /* Borde blanco como en Figma */
        }
        .progress-icon.active {
            background-color: #8fa88f; /* Verde claro Figma */
        }
        .progress-icon svg {
            stroke: #222; /* Trazos oscuros */
        }
        ...
        .delivery-terms {
            ...
            justify-content: space-between;
            padding: 0 1rem;
            background-color: transparent; /* CORRECCIÓN: Fondo transparente para que se vea el crema */
        }
        .term-box {
            text-align: center;
        }
    ...
    <main class="page">
        ...
        <div class="tracking-layout">
            ...
            <section class="tracking-card col-right">
                ...
                <h2 class="track-section-title">Orden #<?php echo $compra_id; ?></h2>
                ...
                <div class="order-inner-card">
                    ...
                    <div class="horizontal-progress">
                        <div class="progress-bar-container">
                            ...
                            <div class="progress-line-active"></div> <div class="progress-icon active">
                ...
                </div> <div class="delivery-terms">
                    <div class="term-box">
                        <span class="term-label">Plazo de entrega</span>
                        <span class="term-value">7 dias</span>
                    </div>
                    <div class="term-box">
                        <span class="term-label">Plazo de entrega</span>
                        <span class="term-value">7 dias</span>
