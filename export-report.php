...
require_once "app/lib/fpdf.php";  // <-- Asegúrate que esta ruta exista
...
if ($format === 'csv') {
    ...
    $filename = "reporte_{$tipo}_{$inicio}_{$fin}.csv";
...
$filename = "reporte_{$tipo}_{$inicio}_{$fin}.pdf";

$pdf = new FPDF();
$pdf->AddPage();
$pdf->SetFont('Arial', 'B', 14);
$pdf->Cell(0, 10, utf8_decode('Raíz Viva - Reporte ' . ucfirst($tipo)), 0, 1, 'C');
...
// Encabezados y contenido según tipo
if ($tipo === 'ventas') {
